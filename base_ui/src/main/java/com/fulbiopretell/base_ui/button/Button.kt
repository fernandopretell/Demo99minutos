package com.fulbiopretell.base_ui.button
...
import com.fulbiopretell.demo99minutos.core.extensions.setSafeOnClickListener
import com.fulbiopretell.demo99minutos.core.extensions.setSvgColor
import com.fulbiopretell.demo99minutos.core.helpers.StylesHelper
...
class Button : LinearLayout {
    ...
    var iconLeft: Int = -1
    var iconRight: Int = -1
    var color: Int = ContextCompat.getColor(context, R.color.core_black_color)
    var rippleColor: Int = ContextCompat.getColor(context, R.color.core_gray_1)
    var isGravityButtonCenter: Boolean = true
    var textColor: Int = ContextCompat.getColor(context, R.color.core_white_color)
    ...
    private var colorDisable: Int = ContextCompat.getColor(context, R.color.core_gray_3)
    var textWithUnderline: Boolean = false
    private var textColorDisable: Int = ContextCompat.getColor(context, R.color.core_gray_4)
    ...
    private fun setupAttrs(context: Context, attrs: AttributeSet) {
        ...
        try {
            ...
            isGravityButtonCenter = ta.getBoolean(R.styleable.Button_btn_is_gravity_center, isGravityButtonCenter)
    ...
    fun setupUI() {
        ...
        this.setOnLongClickListener({
            buttonClickListener?.onLongClick(it)
            true
        })
    ...
    fun updateAttributes(
        color: Int?, iconLeft: Int?, iconRight: Int?, borderRadius: Float?,
    ...
    fun resetStyleColorDisable() {
        this.colorDisable = ContextCompat.getColor(context, R.color.core_gray_3)
        this.textColorDisable = ContextCompat.getColor(context, R.color.core_gray_4)
        setupUI()
    }
